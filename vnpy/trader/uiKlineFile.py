...
class KLineWidget(KeyWraper):
    ...
    def changePath(self):
        ...
        parry = path.split('/')
        l=len(parry)
        symbol = parry[l-1].split('.')
        self.KLtitle.setText(parry[l-2]+"+" +symbol[0])

        self.loadDataBar(self.getTxtData(path))
...
if __name__ == '__main__':
    ...
    ui.loadDataBar(ui.getTxtData(path))
    app.exec_()
